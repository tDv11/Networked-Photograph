...
def main():
    ...
    pygame.mixer.init()
    pygame.mixer.music.load("5 mathematics.mp3")
    ...
    try:
        while True:
            ...
            ( prev_faces, prev_power ) = light.change_light(prev_faces,(len(faces)+(my_friend_faces/2)) ,prev_power)
